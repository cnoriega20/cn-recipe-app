package com.springboot.cnrecipeapp.bootstrap;

import com.springboot.cnrecipeapp.domain.*;
import com.springboot.cnrecipeapp.exceptions.CategoryNotFoundException;
import com.springboot.cnrecipeapp.exceptions.UomNotFoundException;
...
public class RecipeLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        if(!eachUomOptional.isPresent()){
            throw new UomNotFoundException("Expected UOM Not Found");
        }
        ...
        Optional<UnitOfMeasure> cupsUomOptional   = unitOfMeasureRepository.findByDescription("Teaspoon");
        ...
        if(!americanCategoryOptional.isPresent()){
            throw new CategoryNotFoundException("Expected Category Not Found");
        }
        ...
        guacRecipe.setDescription("Just Guacamole");
        ...
        // Notes
        Notes guacNotesDto = new Notes();
        guacNotesDto.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
        ...
        guacNotesDto.setRecipe(guacRecipe);
        guacRecipe.setNotesDto(guacNotesDto);
        ...
        Notes tacoNotesDto = new Notes();
        tacoNotesDto.setRecipeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
        ...
        tacoNotesDto.setRecipe(tacosRecipe);
        tacosRecipe.setNotesDto(tacoNotesDto);
